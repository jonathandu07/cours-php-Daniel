...
<body>
    ...
    if(isset($_POST['soumettre'])){
        ...
        $choix = $_POST['choix'];
        if($_POST['choix']=="1"){
            echo($mois[$_POST['choix']=="1"]);
        }elseif($_POST['secteur']=="2"){
                echo "Vous avez choisi <b>secteur 2</b>";
        }elseif($_POST['secteur']=="SECTEUR_3"){
                echo "Vous avez choisi <b>secteur 3</b>";
        }elseif($_POST['secteur']=="SECTEUR_4"){
                echo "Vous avez choisi <b>secteur 4</b>";
        }
    ?>
</body>
</html>